class Activity < ActiveRecord::Base
  ...
  validates :goal_type, :numerically => {:greater_than_or_equal_to => 0, :less_than => 6}
  validates :state, :numerically => {:greater_than_or_equal_to => 0, :less_than => 5}
  ...
  # allows repeated activty to keep track of its repition children
  has_many :repititions, class_name: "Activity",
    foreign_key: "rep_parent_id", :dependent => :destroy
  belongs_to :rep_parent, class_name: "Activity", foreign_key: "rep_parent_id"
